<div class="col-md-4 col-sm-4 espacio">
  <ul class="nav nav-pills nav-stacked">
    <li class="<?php echo $pagina == 'agregar_sticker_mueblista' ? 'active' : ''; ?>"><a href="?p=agregar_sticker_mueblista" class="oton">Generar QR</a></li>
    ...
    <li class="<?php echo $pagina == 'cambiar_clave_mueblista' ? 'active' : ''; ?>"><a href="?p=cambiar_clave_mueblista" class="oton">Modificar contraseña</a></li>
