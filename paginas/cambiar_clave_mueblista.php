...
<div class="col-md-8 col-sm-8 espacio principal">
    ...
    <form action="<?php echo $pagina == 'agregar_sticker_mueblista' ?>" method="post" onsubmit="return confirmar()" id="validar">
      ...
      <div class="col-sm-12 col-md-12"><input class="btn btn-primary btn-lg btn-block espacio" type="submit" name="guardar" id="guardar" value="Modificar clave"/></div>
      
    <?php clave_mueblista($namex)?>       
    </form>
</div>
